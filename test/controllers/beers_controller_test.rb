...
class BeersControllerTest < ActionController::TestCase
  ...
  test "should create beer" do
    assert_difference('Beer.count') do
      post :create, beer: { description: @beer.description, img_url: @beer.img_url, price: @beer.price, release: @beer.release }
    end
  ...
  test "should update beer" do
    patch :update, id: @beer, beer: { description: @beer.description, img_url: @beer.img_url, price: @beer.price, release: @beer.release }
    assert_redirected_to beer_path(assigns(:beer))
  end
